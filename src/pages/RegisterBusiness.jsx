...
export default function RegisterBusiness() {
	...
	return (
		<Section>
			<div className="pb-16">
				<PageHeader
					title="Înregistrați-vă afacerea"
					subtitle="Completați formularul de înregistrare, iar un membru din echipa noastră vă va contacta pentru validare."
							...
							<form onSubmit={handleSubmit} className="space-y-8">
								...
								<div className="flex justify-end">
									<Button type="submit" disabled={loading}>
										{loading ? <Spinner size="4" className="mr-2" /> : null}
